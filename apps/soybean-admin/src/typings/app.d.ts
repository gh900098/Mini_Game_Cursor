        ...
        manage: {
          game: {
            common: {
              ...
              uploadAudio: string;
              uploadFont: string;
              uploadAudioPlaceholder: string;
              audioCustomTip: string;
              previewThemeAudio: string;
              previewFailed: string;
              audioPlayFailed: string;
              uploadSuccessCheck: string;
              applySuccess: string;
              removeAsset: string;
              managePrizes: string;
            };
            ...
            rules: {
              ...
              startTime: string;
              endTime: string;
              enableDynamicProb: string;
              lossStreakLimit: string;
              lossStreakBonus: string;
              enableBudget: string;
              dailyBudget: string;
            ...
            visuals: {
              ...
              titleImage: string;
              logoWidth: string;
              logoTopMargin: string;
              logoOpacity: string;
              logoDropShadow: string;
              centerHub: string;
              centerType: string;
              centerEmoji: string;
              centerImage: string;
              ...
              wheelBorderSize: string;
              wheelBorderOpacity: string;
              tokenBar: string;
              tokenBarImage: string;
              tokenBarColor: string;
              tokenBarTextColor: string;
              tokenBarShadow: string;
              spinButton: string;
              spinBtnText: string;
              ...
              contentType: string;
              selectIcon: string;
              imageFillMethod: string;
              wheelBorderFrame: string;
              sliceDividers: string;
              centerHubSection: string;
              pointerSection: string;
              brandLogoSection: string;
              ...
              loseTitleImage: string;
              winButtonImage: string;
              loseButtonImage: string;
              winOutcome: string;
              loseOutcome: string;
            ...
            effects: {
              ...
              enableBGM: string;
              enableLedRing: string;
              enableConfetti: string;
              enableStartScreen: string;
              enableHexagons: string;
              enableFloatingParticles: string;
              enableGridFloor: string;
              bgmSettings: string;
              bgmUrl: string;
              bgmVolume: string;
              bgmLoop: string;
              ...
              winSound: string;
              loseSound: string;
              jackpotSoundFile: string;
              tickSound: string;
              tickVolume: string;
              soundButtonSettings: string;
              showSoundButton: string;
              soundButtonOpacity: string;
              confettiSettings: string;
              confettiParticles: string;
              confettiSpread: string;
              confettiColors: string;
              confettiShapeType: string;
              confettiShapeDefault: string;
              confettiShapeEmoji: string;
              confettiEmojis: string;
              confettiPreview: string;
              confettiAddColor: string;
              confettiAddEmoji: string;
              confettiMaxColors: string;
              confettiMaxEmojis: string;
              neonColors: string;
              neonCyan: string;
              neonPink: string;
              neonPurple: string;
              ...
              loseTitle: string;
              loseSubtitle: string;
              audioModeTheme: string;
              audioModeCustom: string;
              audioModeNone: string;
            };
            tabEmbed: string;
            iframeCode: string;
          };
