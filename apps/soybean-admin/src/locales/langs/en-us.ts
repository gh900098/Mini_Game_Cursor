    ...
    manage: {
      game: {
        common: {
          ...
          uploadAudioPlaceholder: 'Please upload audio file',
          audioCustomTip: '💡 File will be saved to your specific folder, won\'t affect theme files',
          previewThemeAudio: 'Preview Theme Audio',
          previewFailed: 'Preview Failed',
          audioPlayFailed: 'Cannot play audio',
          uploadSuccessCheck: 'Upload Success ✓',
          applySuccess: 'Feature enabled',
          removeAsset: 'Remove Feature',
        ...
        tabs: {
          ...
          ux: 'Probability & UX',
          assetGuide: 'Asset Guide',
          embed: 'Embedding'
        },
        assetGuide: {
          title: 'Asset Guide',
          optimizationTitle: 'Optimization Guidelines',
          optimizationDesc: 'To ensure the fastest loading speed for players, please follow these technical requirements for your game assets.',
          targetSize: 'Target Size',
          performanceTips: 'Performance Optimization Tips',
          uploadSuccess: 'Asset uploaded successfully',
          clickToUpload: 'Click to upload',
          featureApply: '🚀 Apply Feature',
          prizeRedirectTip: 'Please configure prize icons and details in the Prizes tab'
        },
        rules: {
        ...
        visuals: {
          ...
          resultPrompts: 'Result Prompts',
          winBackground: 'Win Background (Frame)',
          loseBackground: 'Lose Background (Frame)',
          winTitleImage: 'Win Title Image',
          loseTitleImage: 'Lose Title Image',
          winButtonImage: 'Win Button Image',
          loseButtonImage: 'Lose Button Image',
          winOutcome: 'Win Outcome Settings',
          loseOutcome: 'Lose Outcome Settings',
          jackpotOutcome: 'Jackpot Outcome Settings',
        ...
        effects: {
          ...
          enableFloatingParticles: 'Floating Particles',
          ...
          confettiColors: 'Confetti Colors',
          confettiShapeType: 'Confetti Shape',
          confettiShapeDefault: 'Default Shapes',
          confettiShapeEmoji: 'Emoji',
          confettiEmojis: 'Select Emojis',
          confettiPreview: 'Preview Effect',
          confettiAddColor: 'Add Color',
          confettiAddEmoji: 'Add Custom Emoji',
          confettiMaxColors: 'Maximum 8 colors',
          confettiMaxEmojis: 'Maximum 10 emojis',
