    ...
    manage: {
      game: {
        common: {
          ...
          board: '游戏板设置',
          multipliers: '风险倍数',
          riskMultipliers: '风险倍数网格',
          scoring: '评分',
          bets: '投注选项',
          boxes: '盒子设置',
          categories: '分类',
          scratchPercent: '刮开百分比',
          scratchLayer: '刮层颜色',
          dailyRewards: '每日奖励 (第1-7天)',
          resetOnMiss: '错过时重置连胜',
          streakBonus: '连胜里程碑奖励',
          reelSymbols: '滚轴符号',
          payoutTable: '赔付表',
        ...
        visuals: {
          ...
          wheelBorderFrame: '转盘边框',
          sliceDividers: '分隔线',
          centerHubSection: '中心设置',
          pointerSection: '指针设置',
          brandLogoSection: '品牌Logo',
          tokenBarSection: 'Token显示栏',
          spinButtonSection: '旋转按钮'
        },
        prizes: {
          visualTemplate: '视觉模板',
          quickTemplate: '快速模板',
        ...
        effects: {
          ...
          confettiSpread: '扩散角度',
          confettiColors: '彩纸颜色',
          confettiShapeType: '彩纸形状',
          confettiShapeDefault: '默认纸片',
          confettiShapeEmoji: 'Emoji',
          confettiEmojis: '选择Emoji',
          confettiPreview: '预览效果',
          confettiAddColor: '添加颜色',
          confettiAddEmoji: '添加自定义Emoji',
          confettiMaxColors: '最多8个颜色',
          confettiMaxEmojis: '最多10个Emoji',
          neonColors: '霓虹色设置',
          neonCyan: '青色',
          neonPink: '粉色',
          neonPurple: '紫色',
