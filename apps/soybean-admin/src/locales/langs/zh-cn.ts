    ...
    manage: {
      ...
      game: {
        common: {
          ...
          uploadAudio: '上传音效文件',
          uploadFont: '上传字体文件',
          uploadAudioPlaceholder: '请上传音效文件',
          audioCustomTip: '💡 文件将保存到您的专属文件夹，不会影响主题文件',
          previewThemeAudio: '预览主题音效',
          previewFailed: '预览失败',
          audioPlayFailed: '无法播放音效',
          uploadSuccessCheck: '上传成功 ✓',
          applySuccess: '功能已启用',
          removeAsset: '移除功能',
          managePrizes: '管理奖品',
          gameplay: '游戏玩法',
        ...
        assetGuide: {
          title: '素材指南',
          optimizationTitle: '优化指南',
          optimizationDesc: '为了确保玩家获得最快的加载速度，请遵循这些游戏素材的技术要求。',
          targetSize: '目标尺寸',
          performanceTips: '性能优化建议',
          uploadSuccess: '素材上传成功',
          clickToUpload: '点击上传',
          featureApply: '🚀 立即启用该功能 (Apply)',
          prizeRedirectTip: '请在“奖品配置”标签页中设置奖品图标及详情',
          viewDesignGuide: '查看设计指南',
          designGuideTitle: '主题设计指南',
          downloadGuide: '下载指南',
          downloadSuccess: '设计指南下载成功',
          noThemeSelected: '请先选择主题',
          designGuideNotFound: '未找到该主题的设计指南',
          noContent: '暂无内容'
        },
        rules: {
        ...
        visuals: {
          ...
          resultPrompts: '结果弹窗设置',
          resultTitle: '结果标题',
          resultSubtitle: '结果副标题',
          resultBackground: '结果背景',
          resultTitleImage: '结果标题图片',
          resultButtonImage: '结果按钮图片',
          winBackground: '中奖边框/背景',
          loseBackground: '未中奖边框/背景',
          winTitleImage: '中奖标题图片',
          loseTitleImage: '未中奖标题图片',
          winButtonImage: '中奖按钮图片',
          loseButtonImage: '未中奖按钮图片',
          winOutcome: '中奖结果设置',
          loseOutcome: '未中奖结果设置',
          jackpotOutcome: '大奖结果设置',
          jackpotBackground: '大奖背景',
          jackpotTitleImage: '大奖标题图片',
          jackpotTitle: '大奖标题',
          jackpotSubtitle: '大奖副标题',
          jackpotButtonImage: '大奖按钮图片',
        ...
        effects: {
          ...
          enableHexagons: '悬浮六边形',
          enableFloatingParticles: '悬浮粒子',
          enableGridFloor: '赛博网格地板',
          bgmSettings: '背景音乐设置',
          bgmUrl: 'BGM文件 (.mp3)',
          bgmVolume: 'BGM音量',
          bgmLoop: '循环播放',
