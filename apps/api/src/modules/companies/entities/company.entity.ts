  ...
  integration_config: {
    ...
    syncConfigs?: Record<
      string,
      {
        ...
        maxPointsPerDay?: number; // Daily points limit for Rules Engine
        maxPointsPerMonth?: number; // Monthly points limit for Rules Engine
        maxEligibleDeposits?: number; // Only points for first N deposits
      }
    >;
