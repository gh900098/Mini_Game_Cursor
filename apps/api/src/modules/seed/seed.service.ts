                ...
                configSchema: [
                    {
                        ...
                        items: [
                            ...
                            { key: 'prizeList', type: 'prize-list', label: 'Prize Segments' },
                        ]
                    },
                    {
                        name: 'rules',
                        ...
                        items: [
                                ...
                                items: [
                                    {
                                        ...
                                        type: 'radio',
                                        label: 'Content Type',
                                        options: [{ label: 'Emoji / Preset', value: 'emoji' }, { label: 'Custom Image', value: 'image' }],
                                        default: 'emoji',
                                        span: 24
                                    },
                                    {
                                    ...
                                    { key: 'centerSize', type: 'slider', label: 'Hub Size', min: 40, max: 120, step: 5, suffix: 'px', default: 60, span: 10 },
                                    { key: 'centerBorder', type: 'switch', label: 'Border', default: true, span: 7 },
                                    { key: 'centerShadow', type: 'switch', label: 'Shadow', default: true, span: 7 }
                                ]
                            },
                            {
                                key: 'pointer_section',
                                ...
                                items: [
                                    ...
                                    { key: 'pointerSize', type: 'slider', label: 'Size', min: 40, max: 150, step: 5, suffix: 'px', default: 50, span: 10 },
                                    { key: 'pointerTop', type: 'slider', label: 'Top Pos', min: -100, max: 100, step: 5, suffix: 'px', default: -35, span: 7 },
                            ...
                            },
                            {
                                ...
                                items: [
                                    ...
                                    { key: 'tokenBarTextColor', type: 'color', label: 'Text Color', default: '#ffffff', span: 12 },
                                    { key: 'tokenBarShadow', type: 'switch', label: 'Shadow', default: true, span: 24 }
                                ]
                            },
                            {
                                ...
                                items: [
                                    ...
                                    { key: 'spinBtnTextColor', type: 'color', label: 'Text Color', default: '#451a03', span: 8 },
                                    { key: 'spinBtnColor', type: 'color', label: 'Button Color', default: '#f59e0b', span: 8 },
                                    { key: 'spinBtnShadow', type: 'switch', label: 'Shadow', default: true, span: 8 },
                                    { key: 'spinBtnWidth', type: 'slider', label: 'Width', min: 200, max: 400, step: 10, suffix: 'px', default: 320, span: 12 },
                                    { key: 'spinBtnHeight', type: 'slider', label: 'Height', min: 50, max: 120, step: 5, suffix: 'px', default: 70, span: 12 },
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            },
                            {
                                ...
                                items: [
                                    { key: 'jackpotTitle', type: 'text', label: 'Jackpot Title', default: '🎉 JACKPOT!!! 🎉', span: 24 },
                                    { key: 'jackpotSubtitle', type: 'text', label: 'Jackpot Subtitle', default: 'INCREDIBLE WIN!', span: 24 },
                                    { key: 'winTitle', type: 'text', label: 'Win Title', default: '🎊 WINNER! 🎊', span: 24 },
                                    { key: 'winSubtitle', type: 'text', label: 'Win Subtitle', default: 'Congratulations!', span: 24 },
                                    { key: 'loseTitle', type: 'text', label: 'Lose Title', default: '😅 Better luck next time!', span: 24 },
                                    { key: 'loseSubtitle', type: 'text', label: 'Lose Subtitle', default: 'Try again?', span: 24 }
                                ]
                            }
                        ]
                    },
